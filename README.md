...
and entering your account credentials. Then, you just need to add the heroku remote:

        heroku git:remote -a [the name of your application]

...

In order to interface with Mechanical Turk, you will need to add your AWS Access key and Secret Access key to `appconfig.cfg`. If you don't know how to find these, follow [this simple guide][https://help.bittitan.com/hc/en-us/articles/115008255268-How-do-I-find-my-AWS-Access-Key-and-Secret-Access-Key-]. Then ...
