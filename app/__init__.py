...
#toggle to false to switch out of sandbox mode
debug = True
...
def create():
	...
	#if no qualification has been created
	...
	if 'ibex' in Ibex:
		...
		<ExternalQuestion xmlns="http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2006-07-14/ExternalQuestion.xsd">
		  <ExternalURL>https://mturkrouter-api-heroku.herokuapp.com/surveyCodePage?timeout='''+Timeout+'''</ExternalURL>
		...
		ExternalQuestion = '''
		<ExternalQuestion xmlns="http://mechanicalturk.amazonaws.com/AWSMechanicalTurkDataSchemas/2006-07-14/ExternalQuestion.xsd">
		  <ExternalURL>https://mturkrouter-api-heroku.herokuapp.com/myCustomApp</ExternalURL>
		  <FrameHeight>800</FrameHeight>
		</ExternalQuestion>'''
